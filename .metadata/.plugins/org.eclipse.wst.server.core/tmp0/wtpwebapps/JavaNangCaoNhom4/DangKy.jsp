...
<table width="1000" align="center">
   <tr>
      ...
      <td width="600" valign="top">
	      <form action="DangKyServerlet" method="post">
	      
	      Ho ten: <input name="ht" type="text"> <br>
	      Dia chi: <input name="dc" type="text"> <br>
	      So Dien thoai: <input name="sdt" type="text"> <br>
	      Email: <input name="email" type="text"> <br>
	      Ten dang nhap: <input name="tdn" type="text"> <br>
	      Mat khau: <input name="mk" type="password"> <br>
